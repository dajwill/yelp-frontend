...
var toSubscriber_1 = __webpack_require__(353);
...
var ConnectableObservable_1 = __webpack_require__(46);
...
exports.expandBusiness = exports.updateView = exports.updateLikes = exports.newSearch = exports.store$ = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _rxjs = __webpack_require__(80);
...
var reducer = function reducer(state, action) {
  switch (action.type) {
    ...
    case 'UPDATE_FAVORITE':
      var item = state.favorites.find(function (fave) {
        return fave.id === action.payload.id;
      });
...
var actionCreator = function actionCreator(func) {
  return function () {
    ...
    action.subscribe(function (next) {
      return action$.next(next);
    });
  };
};

var newSearch = actionCreator(function (payload) {
  var filter = payload.filter,
      query = payload.query;

  return _rxjs.Observable.ajax('https://daj-yelp-server.herokuapp.com/search?filter=' + filter + '&query=' + query).map(function (e) {
    return e.response;
    ...
    return _rxjs.Observable.of(error).mapTo({
      type: 'ERROR',
      payload: error
    });
...
var updateLikes = actionDispatcher(function (payload) {
  return {
...
var updateView = actionDispatcher(function (payload) {
  return {
    type: 'UPDATE_VIEW',
    payload: payload
  };
...
var expandBusiness = actionDispatcher(function (payload) {
  return {
...
exports.expandBusiness = expandBusiness;
...
riot.tag2('card', '<div class="card item"> <div class="card-image"> <figure class="image is-3by2"> <img riot-src="{opts.item.image_url}" alt="Image"> <div class="favorite is-overlay is-pulled-right"> <span class="is-pulled-right"> <i if="{!opts.liked}" class="fa fa-heart-o" style="color: white;font-size:2rem;padding:10px;" aria-hidden="true" data-id="{this.id}" onclick="{handleLike}"></i> <i if="{opts.liked}" class="fa fa-heart" style="color: white;font-size:2rem;padding:10px;" aria-hidden="true" data-id="{this.id}" onclick="{handleLike}"></i> </span> </div> </figure> </div> <div class="card-content" style="font-size:1rem;"> <div class="columns is-mobile"> <div class="column is-half business-name"> {opts.item.name} </div> <div class="column"> <rating score="{opts.item.rating}"></rating> </div> <div class="column"> <span class="is-pulled-right">{miles(opts.item.distance)} mi</span> </div> </div> <div class="columns is-mobile"> <div class="column is-third business-type"> {opts.item.categories[0].title} </div> <div class="column"> <span class="is-pulled-right" if="{!opts.item.is_closed}">Open Now</span> </div> <div class="column"> <span class="is-pulled-right">{opts.item.price}</span> </div> </div> </div> </div>', '', '', function(opts) {
    __webpack_require__(360)
    console.log(this.opts);

    this.updateView = (e) => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["updateView"])('business')
    }

    this.handleLike = (e) => {
      e.stopPropagation()
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["updateLikes"])(e.item)
      // setLiked
    }
...
riot.tag2('app', '<div class="spinner" if="{loading}"> <div class="double-bounce1"></div> <div class="double-bounce2"></div> </div> <home if="{view == \'home\'}" search="{search}" listings="{listings}" favorites="{favorites}"></home> <business if="{view == \'business\'}" business="{selected}"></business> <likes if="{view == \'likes\'}" likes="{favorites}"></likes> <footer></footer>', 'app .panel,[data-is="app"] .panel{ font-size: 1.4rem; }', '', function(opts) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__store__["store$"].subscribe((state) => {
...
var VirtualTimeScheduler_1 = __webpack_require__(61);
exports.VirtualTimeScheduler = VirtualTimeScheduler_1.VirtualTimeScheduler;
var AjaxObservable_1 = __webpack_require__(49);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(75), __webpack_require__(39)))
...
riot.tag2('business', '<nav class="panel" style="position:fixed;background-color:white;z-index:10;width:100vw;"> <div class="panel-block"> <a class="button is-outlined" onclick="{changeView}" style="margin-right:10px;">< Back</a> <p class="business-name">{opts.business.name}</p> </div> <card item="{opts.business}"></card> <map coords="{opts.business.coordinates}"></map> map </nav>', '', '', function(opts) {
    __webpack_require__(359)
    this.changeView = (e) => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["updateView"])('home')
});
...
riot.tag2('footer', '<div class="panel" style="position:fixed;bottom:0;background-color:white;z-index:10;width:100vw;"> <div class="panel-tabs" style="justify-content:space-around;"> <a class="is-active"> <i onclick="{changeView}" data-route="home" class="fa fa-search" style="color:#E4BA8E;font-size:1.5rem;"></i> </a> <a><i class="fa fa-compass" style="color:#E4BA8E;font-size:1.5rem;"></i></a> <a><i onclick="{changeView}" data-route="likes" class="fa fa-heart-o" style="color:#E4BA8E;font-size:1.5rem;"></i></a> <a><i class="fa fa-user-o" style="color:#E4BA8E;font-size:1.5rem;"></i></a> </div> </div>', '', '', function(opts) {
    this.changeView = (e) => {
      console.log(e);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["updateView"])(e.target.dataset.route)
    }
});
...
riot.tag2('home', '<nav class="panel" style="position:fixed;background-color:white;z-index:10;width:100vw;"> <div class="panel-block"> <p class="control has-icons-left"> <input class="input is-large" type="text" placeholder="Search" onkeyup="{submit}" onchange="{updateSearch}" riot-value="{search.query}"> <span class="icon is-small is-left"> <i class="fa fa-search" style="color:#E4BA8E;font-size:1.5rem;"></i> </span> </p> </div> <div class="panel-block" each="{option in panelOptions}" onclick="{updateFilter(option.value)}"> <h1>{option.label}</h1> </div> </nav> <div class="list" style="z-index:-10;padding-top:250px;padding-bottom:40px;"> <div each="{opts.listings}"> <card item="{this}" liked="{liked(this.id)}" onclick="{expand}"></card> </div> </div>', 'home .red,[data-is="home"] .red{ color: yellow !important; } home .dot,[data-is="home"] .dot{ height: 15px; width: 15px; background-color: grey; border-radius: 100%; margin: 2px; } home .rating,[data-is="home"] .rating{ display: block; }', '', function(opts) {
    __webpack_require__(73)

    this.on('mount', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["newSearch"])(opts.search)
    })
    ...
    this.expand = (e) => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["expandBusiness"])(e.item)
    ...
    this.updateFilter = (value) => {
      return () => {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["newSearch"])(this.opts.search)
        this.update()
      }
    }
    ...
    this.submit = (e) => {
      if (e.keyCode === 13) {
        this.search.query = e.target.value
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store__["newSearch"])(this.search)
      }
    }
});
...
riot.tag2('likes', 'Likes <card each="{opts.likes}" item="{this}"></card>', '', '', function(opts) {
    __webpack_require__(73);
    console.log(opts.likes);
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_google_maps__ = __webpack_require__(78);
...
riot.tag2('map', '<div id="map-canvas" style="width:100vw;height:30vh;"></div>', '', '', function(opts) {
    __WEBPACK_IMPORTED_MODULE_0_google_maps___default.a.KEY = process.env.GMAPS_AUTH;
    console.log('coords', opts.coords);

    function initMap() {
      console.log('init map');
      return __WEBPACK_IMPORTED_MODULE_0_google_maps___default.a.load(function(google) {
...
riot.tag2('rating', '<div class="rating rating-{score}"> <div class="dot"></div> <div class="dot"></div> <div class="dot"></div> <div class="dot"></div> <div class="dot"></div> </div>', '', '', function(opts) {
